    ...
    >
      <div className="relative max-w-xl w-full mx-auto">
        <div className="relative flex flex-col">
          ...
          <div className="h-12 bg-gradient-to-r from-[#7220e4] to-[#f55cfe] rounded-b-xl">
            <div className="absolute left-3 bottom-3 flex items-center gap-2">
              <label className="cursor-pointer rounded-lg p-2 bg-white/20 hover:bg-white/15">
              ...
              <button
                className="rounded-full flex items-center gap-2 px-1.5 py-1 border h-8
              ...
              >
                ...
                <span className="text-sm pr-3">Search</span>
              </button>
            </div>
