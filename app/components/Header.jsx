    ...
    >
      <div className={`flex flex-row justify-between`}>
        ...
        >
          ...
          <Link href="/auth">
            <div
              className={`px-6 py-1 rounded-[5px] border hover:border flex justify-center items-center hover:border-purple-500 cursor-pointer border-[#1b1c1d] transition-all duration-300 font-200  bg-purple-500 hover:bg-[#1b1c1d]`}
            >
              Get Started
            </div>
          </Link>
