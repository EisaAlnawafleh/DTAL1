...
const Upload = () => {
  ...
  return (
    ...
    >
      ...
      <div
        data-aos="fade-up"
        className={`text-center text-[52px]    text-transparent bg-clip-text   moving-gradient`}
      >
        {" "}
      ...
      <div className={`flex justify-center items-center mt-10   `}>
        <div
          data-aos="fade-up"
          data-aos-delay="200"
          className={`h-105 w-249.5  backdrop-blur-3xl
...
px-4 py-1 rounded-2xl `}
          ...
          >
            ...
            <div data-aos="fade-up" className="pointer-events-none text-white">
            ...
            <div
              data-aos="zoom-in"
              data-aos-delay="400"
              className="bg-[#004ae5]  py-2 px-7 rounded-3xl justify-center items-center mt-5 flex flex-row gap-3 text-white
