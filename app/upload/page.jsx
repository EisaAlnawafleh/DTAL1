    ...
    >
      ...
      >
        ...
        <div className="flex justify-center items-center mt-5 upload_1">
          {/* ⬇️ نفس الكونتينر بدون أي تغيير */}
          <div
            data-aos="fade-up"
            data-aos-delay="200"
            className="
              w-[50%] mx-5 py-[2.5%] min-h-full
          ...
          >
            <div className="flex justify-center">
              <Link href="/upload">
                <div
                  data-aos="zoom-in"
                  data-aos-delay="400"
                  className="bg-white/10 hover:scale-95 text-white border border-white/10 px-4 py-1 rounded-2xl"
                >
            ...
            <label
              ...
              className="
                ...
                flex flex-col pt-5 gap-5 items-center
            ...
            >
              {!videoSelected && (
                <>
                  ...
                  />
                  <div className="text-center pointer-events-none mx-4 text-white">
